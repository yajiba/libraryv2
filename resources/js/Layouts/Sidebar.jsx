            ...
            <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
                ...
                <nav>
                    <ul className="mb-6 flex flex-col gap-1.5">
                        ...
                        <li>
                            <Link
                                className={`group relative flex items-center gap-2.5 px-4 py-2 font-medium duration-300 ease-in-out hover:bg-white hover:text-black dark:hover:bg-meta-4 ${window.location.pathname === '/students' ? 'bg-white dark:bg-meta-4 text-black' : 'text-white'
                                    }`}
                                href={route('Students')}
                            >
                        ...
                        <li>
                            <Link
                                className={`group relative flex items-center gap-2.5 px-4 py-2 font-medium duration-300 ease-in-out hover:bg-white hover:text-black dark:hover:bg-meta-4 ${window.location.pathname === '/departments' ? 'bg-white dark:bg-meta-4 text-black' : 'text-white'
                                    }`}
