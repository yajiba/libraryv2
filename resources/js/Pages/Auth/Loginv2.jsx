...
export default function Loginv2({ status, canResetPassword }) {
        ...
        <GuestLayout>
            ...
            >
                <div className="flex flex-wrap items-center">
                    ...
                    >
                        <div className="w-full p-4 sm:p-12.5 xl:p-12.5">
                            ...
                            <form onSubmit={submit}>
                                ...
                                <div className="mt-6 text-center">
                                    <p className="font-medium">
                                        ...
                                        <Link
                                            href={route('register')}
                                            className="text-primary rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                                        >Sign Up</Link>
